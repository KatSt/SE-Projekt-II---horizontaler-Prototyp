...
public class EditProjektWindow extends JDialog
{
    ...
    * Konstruktor.
    *
    * @param ptitel     Titel des ausgew‰hlten Projekts.
    */
...
//      pack();
   ...
   /** 
    * 
    * Initialisiert die ButtonBox f¸r den South-Bereich.
    *
...
//      });
   ...
   /**
    * 
    * Initialisiert den Tab f¸r die Studenten.
    *
   ...
   private JScrollPane initUnternehmenTab()
   {
      ...
      // JPanel Straﬂehausnr      
      JPanel info2 = new JPanel(new FlowLayout());
      JLabel strasseHausnr = new JLabel("Straﬂe/Hausnummer:");
