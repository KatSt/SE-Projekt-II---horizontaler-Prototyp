...
import Actions.SaveFirebirdConnectionData;
import Actions.TestFirebirdConnection;

/**
 * 
 * Öffnet einen JDialog zur Eingabe der Verbindungsdaten zur Adiuvo(Firebird) Datenbank.
 *
 * @author $Author: Katharina Stein $
 * @version $Revision:  $, $Date: 04.10.2012 $ UTC
 */
@SuppressWarnings("serial")
public class SetFirebirdConnectionData extends JDialog
{
   public SetFirebirdConnectionData()
   {
      super();
      setModal(true);
      setTitle("Verbindungsdaten Adiuvo");
      init();
   }
   /**
    * 
   ...
   public void init()
   {
      ...
      JLabel datenbank = new JLabel("Pfad:");
      ...
      JButton speichern = new JButton(new SaveFirebirdConnectionData(this, hostTextField, portTextField, 
            datenbankTextField, usernameTextField, passwordTextField));
      buttonPanel.add(speichern);
      JButton testen = new JButton(new TestFirebirdConnection(testErgebnis, hostTextField, portTextField, datenbankTextField,
            usernameTextField, passwordTextField, speichern));
